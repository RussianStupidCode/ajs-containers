# [Домашнее задание к лекции «Контейнеры»](https://github.com/netology-code/ajs-homeworks/tree/ajs8/containers)
...
## [`Set`](./src/js/__tests__/team.test.js)
...
## [Map](./src/js/__tests__/errors.test.js)
...
## [Map (задача со звёздочкой)](./src/js/__tests__/settings.test.js)
